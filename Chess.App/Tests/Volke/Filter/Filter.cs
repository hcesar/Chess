...
namespace LookPoint.Filters
{
    ...
    public class GazePoint
    {
        ...
        /// Gaze X
        /// </summary>
        public float X { get { return iX; } set { iX = value; } }
        /// <summary>
        /// Gaze Y
        /// </summary>
        public float Y { get { return iY; } set { iY = value; } }
        /// <summary>
        /// Timestamp (ms)
        /// </summary>
        ...
        /// Gaze location
        /// </summary>
        public PointF Location { get { return new PointF(iX, iY); } }
        ...
        public GazePoint(PointF aPoint, int aTimestamp)
        {
            iX = aPoint.X;
            iY = aPoint.Y;
        ...
        /// <param name="aTimestamp">Timestamp (ms)</param>
        public GazePoint(float aX, float aY, int aTimestamp)
        {
            iX = aX;
            iY = aY;
            iTimestamp = aTimestamp;
    ...
    public abstract class Filter
    {
        ...
        public PointF feed(int aTimestamp, PointF aGazePoint)
        {
            if (iStartTime < 0)
            {
